...
<script>
  ...
  import JVxeCellMixins from '@/components/leadingtek/JVxeTable/mixins/JVxeCellMixins'
  import { ACCESS_TOKEN } from '@/store/mutation-types'
  import JFilePop from '@/components/leadingtek/minipop/JFilePop'

  import JVxeUploadCell from '@/components/leadingtek/JVxeTable/components/cells/JVxeUploadCell'
