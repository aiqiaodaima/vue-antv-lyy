...
<script>
  ...
  import JSuperQuery from '@/components/leadingtek/JSuperQuery.vue';
  import JInput from '@/components/leadingtek/JInput.vue';
  ...
  export default {
    ...
    methods: {
      ...
      //跳转单据页面
      jump() {
        this.$router.push({path: '/leadingtek/helloworld'})
      },
