          ...
          <div style="border-bottom: 1px solid #ddd; margin-top: 10px">
            <a-form-model ref="ruleForm" :model="formData" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-form-model-item label="指令来源" prop="channel">
                <a-select v-model="formData.channel">
                  <a-select-option
              ...
              <a-form-model-item label="指令类型" prop="caseType">
                <a-select v-model="formData.caseType">
                  <a-select-option
              ...
              <a-form-model-item label="业务类型" prop="bizTypeCode">
                <a-select v-model="formData.bizTypeCode">
              ...
              <a-form-model-item label="客户名称" prop="customerName">
                <a-input v-model="formData.customerName" />
              </a-form-model-item>
            </a-form-model>
          </div>
          <div style="margin-top: 10px">
            <a-form-model ref="ruleForm" :model="formData" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-form-model-item label="付款账号" prop="payAccount">
                <a-row :gutter="24">
                  <a-col :span="15">
                    <a-input v-model="formData.payAccount" />
                  </a-col>
              ...
              <a-form-model-item label="付款户名" prop="payAccountName">
                <a-input v-model="formData.payAccountName" />
              </a-form-model-item>
              <a-form-model-item label="收款账号" prop="recvAccount">
                <a-input v-model="formData.recvAccount" />
              </a-form-model-item>
              <a-form-model-item label="收款户名" prop="recvAccountName">
                <a-input v-model="formData.recvAccountName" />
              </a-form-model-item>
              <!-- <a-form-model-item label="开户行">
                <a-input v-model="formData.payBankName" />
              </a-form-model-item> -->
              ...
              <a-form-model-item label="大额行号" prop="payBankNo">
                <a-input v-model="formData.payBankNo" />
              </a-form-model-item>
            </a-form-model>
          </div>
        </a-col>
        <a-col :span="12">
          <a-form-model ref="ruleForm" :model="formData" :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-form-model-item label="付款类型" prop="transferType">
              <a-radio-group v-model="formData.transferType" :default-value="1">
            ...
            <a-form-model-item label="金额" prop="amount">
              <a-select v-model="formData.amount" />
            </a-form-model-item>
            <a-form-model-item label="大写金额" prop="capitalAmount">
              <a-select v-model="formData.capitalAmount" />
            </a-form-model-item>
            <a-form-model-item label="用途" prop="payPurpose">
              <a-row :gutter="24">
                <a-col :span="12">
                  <a-select v-model="formData.payPurpose" :size="size" default-value="自定义" style="width: 200px" @change="handleChange">
                    <a-select-option
            ...
            <a-form-model-item label="是否立即划款" prop="isReceipt">
              <a-radio-group v-model="formData.isReceipt" :default-value="1" @change="onChange">
                <a-radio :value="1"> 是 </a-radio>
                <a-radio :value="2"> 否 </a-radio>
              </a-radio-group>
            </a-form-model-item>
            <a-form-model-item label="流程备注" prop="transNote">
              <a-input v-model="formData.transNote" type="textarea" placeholder="请输入备注,最多输入100个字符" />
            </a-form-model-item>
          </a-form-model>
        </a-col>
      </a-row>
